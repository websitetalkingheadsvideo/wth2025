...
$url=$_GET[url];
$poster=$_GET[poster];
	$url="http://websitetalkingheads.com/ivideo/videos/Talking Heads Demo 30 sec.mp4";
	$poster="http://websitetalkingheads.com/ivideo/videos/Talking Heads Demo 30 sec.png";
?>
