...
if(!$xml=simplexml_load_file('http://www.websitetalkingheads.com/spokespeople/femaleactors.xml')){
...
//if(!$xml=simplexml_load_file('http://www.websitetalkingheads.com/spokespeople/femaleactors2.xml')){
//    trigger_error('Error reading XML file',E_USER_ERROR);
//}
//foreach($xml as $item){
//	$actor = $item['caption'];
