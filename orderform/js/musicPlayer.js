...
function musicChosen(obj){
	var chosenMusic = obj.value;
	document.getElementById('musicChosen').innerHTML = chosenMusic;
	document.getElementById('music').value = chosenMusic;
}