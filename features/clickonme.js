...
wthvideo.params = {
	...
	top:"auto",
	bottom:"0px",
	vidlink:"http://www.websitetalkingheads.com/order.html",
	delayclose:5000,
	flv:"chantelclickonme"};
	openin:"_blank",
...
wthvideo.drawVideo= function(){
	...
	markUp += '  <object id="objvideo" style="outline:none;" type="application/x-shockwave-flash" width="'+wthvideo.params.width+'" height="'+wthvideo.params.height+'" data="features/wthplayerlink.swf">';
	markUp += '    <param name="movie" value="features/wthplayerlink.swf" />';
	markUp += '    <param name="quality" value="high" />';
	markUp += '    <param name="flashvars" value="vurl='+wthvideo.params.flv+'.flv&amp;vwidth='+wthvideo.params.width+'&amp;vheight='+wthvideo.params.height+'&amp;vlink='+wthvideo.params.vidlink+'&amp;openin='+wthvideo.params.openin+'&amp;delayclose='+wthvideo.params.delayclose+'" />';
