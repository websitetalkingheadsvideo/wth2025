...
<div class="exampleTitle">Whiteboard Video</div>
<div class="vpbanner">
    ...
    <div class="vpbanner-center">
	    <div align="center"><a rel="vidbox 640 385" title="Why Talking Heads Video?" href="http://www.youtube.com/watch?v=NiCdoZ_7kcA&hd=1" target="_blank"><img src="http://www.websitetalkingheads.com/videopresentations/images/vpgif.gif" alt="Why Talking Heads Video?" width="250" height="142" id="WhyVideo"   onmouseover="onWhyVideo()" onmouseout="outWhyVideo()"/></a></div>
    </div>
    <div class="vpbanner-right">
    	<a href="../../order.php"><img src="images/Whiteboard219.png" width="219" height="146" alt="Results Driven Whiteboard Videos" id = "Results Driven Whiteboard Videos"  onmouseover="onWResults()" onmouseout="outWResults()"/></a>
    </div>
</div>
<div class="clearSpace"></div>
     ...
     <div class="examples">
	 	<?php include ('includes/examples-whiteboardFull.php'); ?>
     </div>
  <div class="c"></div>  
