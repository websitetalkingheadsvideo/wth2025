...
var x = document.getElementById('quoteBlock'),
    i = 0;  
...
document.getElementById("BestInSearchSpokesperson").src="https://www.websitetalkingheads.com/images/seoSpokesperson.png";
}
function outBestInSearch(){
document.getElementById("BestInSearchSpokesperson").src="https://www.websitetalkingheads.com/images/TopSEOs-virtualspokesperson.gif";
}function onHTML5Logo(){
document.getElementById("HTML5Logo").src="https://www.websitetalkingheads.com/images/HTML5_Logo_over.png";
}
