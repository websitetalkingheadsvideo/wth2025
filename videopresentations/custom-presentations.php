...
<!-- InstanceBeginEditable name="doctitle" -->
  <title>Custom Video Presentation from Talking Heads&reg;</title>
  <meta name="title" content="Custom Video Presentation from Talking Heads">
...
<h5 class="card-header bg-gradient-mine text-white text-center text-uppercase">Custom <strong>Video Presentation</strong> Uses</h5>
    <div class="card-body">
      <div class="row">
        <div class="col-lg-6">
...
<div class="container">
    <h2 class="text-capitalize text-center">Custom Video</h2>
    <p>Custom videos can turn a website into an interactive and engaging experience. Use <em>Web Video</em> to showcase your company, products, or services. It is the best way to promote your brand and convert visitors into customers.</p>
    <p>A <strong>custom video presentation</strong> on a website has the potential to increase conversions by 80%. It is one of the best ways of turning site visitors into buyers.</p>
