var Videobox = {
	...
	video: function(sLinkHref){
      ...
      this.flash = true;
			...
			this.so = new SWFObject("http://www.youtube.com/v/"+this.videoID+"&autoplay=1&rel=0", "flvvideo", this.options.contentsWidth, this.options.contentsHeight, "0");

			this.so.addParam("wmode", "window");
