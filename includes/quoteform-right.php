...
<div id ="formtoptext2">Request a Quote</div>


  <span class="formLabel2">Name</span>
          <input name="Name" type="text" class="formInput2" id="Name" placeholder="Your name here" size="35"><br />
          <span class="formLabel2">Company</span>
         <input name="Company" type="text" class="formInput2" id="Company" size="35" placeholder="Your company here"> <br />
         <span class="formLabel2">Email</span>
    <input name="mailfrom" type="email" class="formInput2" id="email" placeholder="Your email here" size="35"><br />
  <span class="formLabel2">Phone</span>
    <input name="Phone" type="tel" id="Phone" class="formInput2" placeholder="XXX-XXX-XXXX" size=35> 
<br /><br />
  <span class="formLabel2">Message</span>
    <textarea name="Comments" rows="3" class="formTextFieldV"></textarea>
