...
<form action="../cgi-sys/formmail.pl" method="POST" enctype="multipart/form-data" name="quoteForm" target="_self" class="form">
<input name="subject" type="hidden" value="Quote Request">
<input name="recipient" type="hidden" id="recipient" value="sales@websitetalkingheads.com, andy@websitetalkingheads.com">
...
<div id="formRight" >
    ...
    <textarea name="Comments" id="Comments" cols="46" rows="3" class="formTextField"></textarea>
         <input type="hidden" name="Sent From IP" value="<?php echo $_SERVER['REMOTE_ADDR']; ?>" />
