...
document.addEventListener('DOMContentLoaded', function() {
	...
	console.log("nav loc:", loc);
	// Clear all menu items first to prevent stale "current" classes
	var menuHome = document.getElementById( 'menuHome' );
	var menuActors = document.getElementById( 'menuActors' );
	var menuOrder = document.getElementById( 'menuOrder' );
	var menuWhiteboard = document.getElementById( 'menuWhiteboard' );
	var menuVideos = document.getElementById( 'menuVideos' );
	var menuContact = document.getElementById( 'menuContact' );
	var specials = document.getElementById( 'specials' );
	
	if (menuHome) menuHome.className = "";
	if (menuActors) menuActors.className = "";
	if (menuOrder) menuOrder.className = "";
	if (menuWhiteboard) menuWhiteboard.className = "";
	if (menuVideos) menuVideos.className = "";
	if (menuContact) menuContact.className = "";
	if (specials) specials.className = "";
	...
	switch ( loc ) {
		...
		case "/examples/index.php":
			currentItem = document.getElementById( 'menuExamples' );
			break;
		case "/pricing/index.php":
			currentItem = document.getElementById( 'menuPrices' );
			break;
	...
	if (currentItem) {
		...
		console.log("Set current menu item:", currentItem.id);
	} else {
		console.log("No matching menu item for loc:", loc);
	}
});
</script> 
