...
<div id="preload">
    <img src="../images/specialsbtn_on.jpg" width="1" height="1" alt="Click here for our Specials"/>
    <img src="../images/menu-button_on-purple.png" width="1" height="1" alt="here to see our whiteboard videos"/>
</div>
<header>
    <section id="header_top">
    <h1 class="left hidden">Website Talking Heads&reg;</h1>
    <h3><a href="tel://801-748-2281" title="Give us a call.">801-748-2281</a></h3>
  </section>
	 <nav id = "Talking-Heads-Navigation">
            <ul>
                <li><a href="https://www.websitetalkingheads.com/index.php" id="menuHome"><h2>Home</h2></a></li>
                <li><a href="
https://websitetalkingheads.com/actors/female-carousel.php" id="menuActors"><h2>Actors</h2></a></li>
                <li><a href="https://www.websitetalkingheads.com/examples/index.php" id="menuExamples"><h2>Examples</h2></a></li>
                <li><a href="https://www.websitetalkingheads.com/pricing/index.php" id="menuPrices"><h2>Prices</h2></a></li>
                <li><a href="https://www.websitetalkingheads.com/orderform/index.php" id="menuOrder"><h2>Order</h2></a></li>
              	<li><a href="https://www.websitetalkingheads.com/whiteboard/index.php" id = "whiteboard"><h2>White<br/>Board</h2></a></li>
                <li><a href="https://www.websitetalkingheads.com/videopresentations/index.php" id="menuVideos"><h2>Videos</h2></a></li>
                <li><a href="https://www.websitetalkingheads.com/contact.php" id="menuContact"><h2>Contact</h2></a></li>
                <li><a href="https://www.websitetalkingheads.com/specials/"  id="menuSpecials"><h2>Specials</h2></a></li>
            </ul>
     <div id="c"></div>
     <div class="line"></div>
     </nav>
