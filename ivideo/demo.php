...
echo PHP_EOL;
echo '<div class="actor-row">';
echo PHP_EOL;
foreach ( $xml as $item ) {
	$spokespeson = $item[ 'caption' ];
	echo '<div class="poster actor" alt="' . $spokespeson . '" Video Spokesperson" data-toggle="modal" data-target=".modal-demo" data-video="' . $spokespeson . '">';
	echo PHP_EOL;
	...
	echo '<script type="application/ld+json">
	{
		...
		"thumbnailUrl": "https://www.websitetalkingheads.com/carimages/' . $spokespeson . '.jpg",
		...
		"contentUrl": "https://www.websitetalkingheads.com/spokespeople/videos/' . $spokespeson . '.mp4",
