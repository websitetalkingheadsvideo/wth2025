  ...
  <div class="row my-1 vertical-align" id="ht">
    ...
    <div class="col-xl-4 col-lg-4">
      <div id="contact">
        ...
        <div class="text-center"> <a class="phone-contact" href="tel://801-748-2281" title="Give us a call.">801-748-2281</a> </div>
        <div id="awards">
          <?php include("includes/random-awards.php"); ?>
        </div>
      </div>
    </div>
  </div>
...
<section class="container-fluid">
  ...
  <div class="card-deck card-spokesperson mb-2">
    <div class="card">
      ...
      <div class="card-body" style="margin-top: 288px">
        <p class="card-text">Stack the odds in your favor with accurate and clearly defined messaging. If you want to get the most of your website and marketing effort, you need a website spokesperson.</p>
      </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-text">Add a Spokesperson to your website to welcome visitors and direct them to key areas. Increase conversion rates and boost leads. Uses <em>HTML5 Video</em> and Canvas for the Transparent effect. If the browser doesn't support this we use a regular MP4s.</p>
      </div>
...
<section class="alert alert-info">
  <div class="card-deck mb-2">
    <div class="card">
      <div class="embed-responsive embed-responsive-16by9">
        <iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" type="text/html" src="ivideo/talking-heads-player.php?video=Premier Health&autostart=no&controls=show"></iframe>
      </div>
      <div class="card-body">
...
<section class="alert alert-info">
  ...
  <div class="row">
    ...
    <div class="col-lg-6">
      <div id="about-video">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" type="text/html" src="ivideo/talking-heads-player.php?video=About Talking Heads&autostart=no&controls=show"></iframe>
        </div>
      </div>
    </div>
  </div>
...
<section class="container">
  <h2>The Talking Heads® Mission</h2>
  <div class="mission">Talking Heads® is an online company that focuses on providing individuals and businesses with custom videos that would best present their interests and brand.</div>
  <blockquote>
...
<script>
		$( document ).ready( function () {
            ...
            if($( '#about-video' ).height() < $("#about").height()){
			$( '#about-video' ).padHeight();
            }else{
			$( '#about' ).padHeight();
            }
      if($( '#contact' ).height()<$( '#video' ).height()){
			$( '#contact' ).padHeight();
      }else{
			$( '#video' ).padHeight();
      }
