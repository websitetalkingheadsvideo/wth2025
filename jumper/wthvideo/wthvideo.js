...
function wthplayer() {
	...
	iPhoneWidth = "160",//When the above happens, the witdh of the image
        width = "160", //video width
        height = "256", //video height
        ...
        actorpic = "jedjumper", //transparent gif
        canvasVideo= "jedjumper-canvas",//Just name,not extension
        h264= "jedjumper",//Just name,not extension h264
        ...
        overflow = "hidden",
        setWidth = 140, //set width of click to play button
        ...
        curLocation, roundFrame, theCurrentFrame, curTime, theParent, actorGif, iPhoneVideo, clickImage, thplayer, spokespersonImage, thb, thv, PlayerBar, newP, playerClose, restartBtn, muteBtn, createTH, toPlay, dv, playingS, outputCanvas,theCanvas, thc, imgLink = null,
    ...
    function HTML5Autostart() {
        ...
        //----------------------------------------------------------------------------------------------------
	function timeUpdate() {
		    curLocation= document.getElementById('wthvideo').style;
	        curTime = thplayer.currentTime;
	        theCurrentFrame = Math.floor(curTime * frameRate);
	        roundFrame = Math.round(theCurrentFrame / 10);
	        switch (roundFrame) {
	            case 26:
	            case 25:
	                curLocation.top = "300px";
	                curLocation.marginLeft = "-640px";
	                break;
	            case 37:
	            case 38:
	                curLocation.top = "300px";
	            ...
	            case 62:
	                curLocation.top = "300px";
	                curLocation.marginLeft = "460px";
	                break;
	            case 83:
	            case 84:
				case 136:
				case 137:
	                curLocation.top = "500px";
	                curLocation.marginLeft = "340px";
	                break;
	            case 103:
	            case 102:
	                curLocation.top = "50px";
	                curLocation.marginLeft = "-440px";
	                break;
	            case 114:
	            case 113:
	                curLocation.top = "50px";
	                curLocation.marginLeft = "-10px";
	                break;
	            default:
	                break;
	        }
