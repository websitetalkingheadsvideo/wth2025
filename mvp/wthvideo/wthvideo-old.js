...
wthvideo.drawVideo= function(){
	...
	markUp += '  <object id="objvideo" style="outline:none;" type="application/x-shockwave-flash" width="'+wthvideo.params.width+'" height="'+wthvideo.params.height+'" data="../../mvp4/wthvideo/'+wthvideo.params.path+'/wthplayer.swf">';
	markUp += '    <param name="movie" value="../../mvp4/wthvideo/'+wthvideo.params.path+'/wthplayer.swf" />';
