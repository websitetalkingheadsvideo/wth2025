...
<head>
<meta charset="utf-8">
<title>Talking Heads®|Choosing a Video Spokesperson</title>
...
<link href="../css/choosing-a-video-spokesperson-index.css" rel="stylesheet" type="text/css">
</head>
...
<video playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
  <source src="https://www.websitetalkingheads.com/ivideo/videos/What is a Talking Head.mp4" type="video/mp4">
</video>
<div class="container-fluid h-100">
<div class="container-fluid choosing-spokesperson-header">
  <div class="row text-center choosing-spokesperson-header">
    <div class="text-white col-lg-9">
      <h1 class="display-4 wow bounceInDown">Choose a Video Spokesperson for your Business</h1>
      <p class="lead mb-0 wow bounceInUp">Finding the Virtual Spokesperson that is right for you.</p>
    </div>
...
<section class="alert bg-black text-primary">
  <div class="py-1">
    <h3 class="text-centered wow fadeInLeftBig">What is a Website Spokesperson?</h3>
    <div class="row">
...
<section class="container-fluid my-3">
  <div class="card-group">
    <div class="card card-primary">
      ...
      <div class="card-body">
        <?php $actor="Angie";$pull="center"; include("../ivideo/showActor.php"); ?>
    ...
    <div class="card card-primary">
      ...
      <div class="card-body">
        <?php $actor="Jed";$pull="center"; include("../ivideo/showActor.php"); ?>
    ...
    <div class="card card-primary">
      ...
      <div class="card-body">
        <?php $actor="Marissa";$pull="center"; include("../ivideo/showActor.php"); ?>
