...
function wthplayer() {
	...
	iPhoneWidth = "256",//When the above happens, the witdh of the image
        ...
        divTop= "318",
        bottom= "auto",
        centeroffset= "100",//if centering on page negative numbers are left and positive numbers are right
        ...
        canvasVideo= "RandomA-canvas",//Just name,not extension
        h264= "RandomA",//Just name,not extension h264
	...
	//Randomize Video Played
	var dArray = ["RandomA","RandomB","RandomC","RandomD","RandomE","RandomF","RandomG"];
	var cArray = ["RandomA-canvas","RandomB-canvas","RandomC-canvas","RandomD-canvas","RandomE-canvas","RandomF-canvas","RandomG-canvas"];
	var randomNumber = Math.floor((Math.random() * cArray.length));
	 canvasVideo = cArray[randomNumber];
	 h264 = dArray[randomNumber];
