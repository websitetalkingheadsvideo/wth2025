...
<head>
	...
	<title>Talking Heads&reg;|Random Player</title>
	<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=iso-8859-1">
	<meta name="keywords" content="online spokesperson, video spokesperson, website talking heads, website actor, website video, transparent flash, virtual spokesperson, spokesperson, video presenter, website presenter, website spokesperson, video salesperson, canvas, HTML5">
	...
	<section class="container">
		...
		<div class="row" style="height:400px">
			<div class="col-md-6 center-block">
				<h3>With this player a visitor gets a random video each time they visit your site.</h3>
				<h4><a href="javascript:location.reload(true)">Click here to refresh this page to see another Video.</a></h4>
			</div>
		</div>
	</section>
