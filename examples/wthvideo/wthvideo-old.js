...
//Variables for Player
	...
	var vidlink= "no";
	var openin= "_blank";
	var path= "https://www.websitetalkingheads.com/examples/wthvideo";
	...
	var posterImg= "rennyexamples";//Just name,not extension.  use a jpg for iOS, if left blank the png will be used.
// end Vars	
...
if( p === 'iPad' || p === 'iPhone' || p === 'iPod' ){
	...
	overflow = "visible";
	if(bottom != "auto"){
		bottom = parseInt(bottom) + (parseInt(playerBarHeight)/2);
	}
	playerBarMarginTop = "-2px";
	if(posterImg == ""){
		posterImg = actorpic;
	}else{
