...
wthvideo.drawVideo= function(){
	...
	if(isiPad || navigator.platform == 'iPad' || navigator.platform == 'iPhone'|| navigator.platform == 'iPod' ) {
		...
		markUp += '<video poster="'+wthvideo.params.path+'/'+wthvideo.params.iactorpic+'" controls="controls" width="'+wthvideo.params.iwidth+'" height="'+wthvideo.params.iheight+'"autoplay="autoplay">';
