...
<?php include ('includes/google-site-tags.php'); ?>
</head>
    ...
    <div class="mt-2">
        <div class="row d-flex align-items-center">
            <div class="col-lg-7 offset-1" id="video-holder">
                <?php $video = "Whiteboard Showreel";$bgColor = "#7ECDF4";$btnColor = "#3D9CEB";$alt = "Whiteboard Showreel";include("includes/showVideo.php"); ?>
            </div>
            <div class="col-lg-3">
...
<div class="d-box pb-1">
    <a href="../mrss/whiteboard.rss">
        <img class="mx-auto d-block" src="../mrss/images/Talking-Heads-RSS-Feed.png" width="28" height="28" title="Talking Heads Whiteboard® RSS Feed" alt="Talking Heads® Whiteboard RSS Feed"/>
    </a>
    </section>
    <section class="content">
        <div class="container text-center">
            <div class="examples clearfix p-2">
                <h2 class="banner-bottom-text p-0">Animation Videos<br />
                    <a href="../videopresentations/animation.php">
                        More Examples
                    </a>
                </h2>
                <?php
            ...
            <div class="container pt-2">
                ...
                <div class="container p-2">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="col-6">
                            <div class="content-text">Obviously, not all whiteboard style videos are alike, so,we work with you to create the best whiteboard video for your company. We focus on supercharged messages utilizing a hand drawn whiteboard commercials for that triggers focus and engagement That&apos;s where we come in. We create high impact, exciting whiteboard drawing VIDEOS that explain your product, service, software or business.</div>
                        </div>
                    </div>
                </div>
            </div>
