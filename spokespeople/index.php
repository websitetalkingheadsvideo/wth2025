...
<section class="container-fluid py-4">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 mb-4">
        <div class="card h-100">
          ...
          <div class="card-img-top embed-responsive embed-responsive-16by9">
            <div class="embed-responsive-item">
              <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/980921949?h=db50b75aa5&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Spokespeople"></iframe></div>
            </div>
          </div>
          <div class="card-body">
    ...
    <div class="row">
      <div class="col-md-6 mb-4">
        <div class="card h-100">
          <h3 class="card-header text-center text-white">Meet Your On-Camera Talent</h3>
          <div class="card-img-top embed-responsive embed-responsive-16by9">
            <div class="embed-responsive-item">
              <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/980936165?h=ac4c3a0ff7&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="Virtual Spokespeople"></iframe></div>
            </div>
          </div>
          <div class="card-body">
            <p class="card-text">Picking the right spokesperson can make all the difference in how your message comes across. That's why we've got a lineup of awesome, professional on-camera talent ready to help you connect with your audience. Whether you're going for friendly and approachable or sleek and professional, we've got someone who fits the vibe. Our spokespeople are great at turning scripts into natural, engaging messages that actually get attention. Take a look through our videos to see who feels like the best match for your brand. It's not just about looking good on camera—it's about creating a real connection with your viewers. Let's find the perfect face to represent your business!</p>
          </div>
        </div>
      </div>
      <div class="col-md-6 mb-4">
        <div class="card h-100">
          ...
          <div class="card-img-top embed-responsive embed-responsive-16by9">
            <div class="embed-responsive-item">
              <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/980936165?h=ac4c3a0ff7&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="What is a Talking Head"></iframe></div>
            </div>
          </div>
          <div class="card-body">
            <h5 class="card-title text-white"><span class="small-caps">There are numerous terms to explain a Website Spokesperson</span></h5>
