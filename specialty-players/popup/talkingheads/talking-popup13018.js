	...
	talkingPopup: function () {
		...
		function wthplayer() {
			...
			var responsive = "yes", //You must place <div id="popup"></div> inside the div you want the video to be in.
				...
				theParent, actorGif, clickImage, spokespersonImage, thb, talkingHead, PlayerBar, newP, playerClose, restartBtn, muteBtn, talkingHead, dv, playingS, outputCanvas, theCanvas, thc, imgLink = null,
