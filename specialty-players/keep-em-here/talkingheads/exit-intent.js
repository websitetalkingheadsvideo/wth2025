...
jQuery.fn.extend({
	talkingPopup: function () {
		...
		$("<style type='text/css'>#reporter{color:#e900f7} #message{color:black} #message{font-size:2rem} #column-2{width:380px;padding:160px .5rem 0 0} #column-1{width:330px;height:340px} #column-1,#column-2{float:left;margin:2px} #row{max-width:760px;margin:45px auto 0;clear:both} #exitpopup { text-align: center;width:" + popupWidth + "px; height:" + popupHeight + "px;background-position: center 0%;background-repeat: no-repeat; margin:0px auto; display:none; position:fixed; color:#000000;  -webkit-border-radius: 4px; -moz-border-radius: 8px; border-radius: 8px;border:2px solid #22b101; z-index:999999; background:rgb(20, 20, 20); background:#FFFFFF; } #popup_title { margin-top: 0px; padding-top: 0px;color:#DA0225!important } #exitpopup p { text-align: left; } #exitpopup_bg{display: none; width:100%; height:100%; position:fixed; background:#000000; opacity: .8; filter:alpha(opacity=0.8); z-index:999998;}#popupClose{margin-left: " + exitLeft + "px;}</style>").appendTo("head");
		$(document).mousemove(function (e) {
			...
			if (e.pageY <= 5) {
				if (!up) {
					...
					if (moveTime < 3) {
						canvasVideo = "Keep Vid 1 Matte-hb";
						...
						canvasVideo = "Keep Vid 2 Matte-hb";
						...
						canvasVideo = "Keep Vid 5 Matte-hb";
...
function popupPlayer() {
	...
	var responsive = "yes", //You must place <div id="talkingPopup"></div> inside the div you want the video to be in.
		...
		textColor = "#e900f7", //set color of text
		volume = "0.8",
		...
		actorpic = "Half Body", //transparent gif
