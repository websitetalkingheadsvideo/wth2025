...
// JavaScript Document
		...
		$( document ).ready( function () {
			...
			$( '#exitpopup' ).css('background-image', 'url(talkingheads/POSTALSERVICEExitIntentBackgroundSEPT18.jpg)');
...
function popupPlayer() {
	...
	var responsive = "yes", //You must place <div id="talkingPopup"></div> inside the div you want the video to be in.
		...
		canvasVideo = "video 3 matte", //Just name,not extension
		h264 = "Video 3-hb", //Just name,not extension h264
