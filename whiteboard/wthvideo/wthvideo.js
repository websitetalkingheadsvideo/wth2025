...
function wthplayer() {
	...
	iPhoneWidth = "440",//When the above happens, the witdh of the image
        width = "440", //video width
        ...
        autostart= "onceonlythenpic",//autostart options yes, no, mute, oncethenpic, oncethenmute, onceonlythenpic, onceonlythenmute, and loop
        exitoncomplete = "yes", //option for player to close after video completes. "yes" or "no"
        oncepersession = "yes", //option for number of times video plays "yes", "no", or "onceonly"
        vidLink = "", //make the Talking Heads Player a link. Either leave this set to "no" or you can put a complete URL inside the quotes.
        openIn = "_blank",
        path = "https://www.websitetalkingheads.com/whiteboard/wthvideo", //path to where the files are located
        actorpic = "TheHand", //transparent gif
        canvasVideo= "TheHandMatte",//Just name,not extension
        h264= "TheHandNew",//Just name,not extension h264
