...
<div id="get-a-quote">
  ...
  <form accept-charset="utf-8" action="https://websitetalkingheads.od1.vtiger.com/modules/Webforms/capture.php" enctype="multipart/form-data" id="__vtigerWebForm" method="post" name="Animation Captcha">
    <input name="__vtrftk" type="hidden" value="sid:db215ee5aa89f1bb40e39a7b511488198d42ed36,1554156352">
    <input name="publicid" type="hidden" value="177960eaa264e5ce0866fffab2f61560">
    <input name="urlencodeenable" type="hidden" value="1">
    <input name="name" type="hidden" value="Animation Captcha">
    <input name="__vtCurrency" type="hidden" value="1">
    <div class="inputs">
      <label>Last Name</label>
      <input data-label="" maxlength="80" name="lastname" required="" type="text" value="">
      <label>Primary Email *</label>
      <input data-label="Primary Email" name="email" required="" type="email" value="">
      <label>Primary Phone *</label>
      <input data-label="" maxlength="50" name="phone" required="" type="text" value="">
      <label>Email Opt-in</label>
      <input data-label="" name="emailoptin" type="hidden" value="0">
      <input data-label="" name="emailoptin" type="checkbox" value="1">
      <label>Message</label>
      <textarea name="description"></textarea>
      <input data-label="" maxlength="255" name="cf_1001" type="hidden" value="https://www.websitetalkingheads.com/whiteboard/animation.php">
    </div>
  </form>
</div>
...
<div class="d-flex btn-holder">
  <input class="btn btn-custom" id="vtigerFormSubmitBtn" type="submit" value="Learn More">
</div>
</form>
