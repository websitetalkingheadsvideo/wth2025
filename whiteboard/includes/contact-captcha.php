...
<form name="Whiteboard Captcha" id="__vtigerWebForm" action="https://websitetalkingheads.od1.vtiger.com/modules/Webforms/capture.php" enctype="multipart/form-data" method="post" accept-charset="utf-8">
  <input name="__vtrftk" type="hidden" value="sid:8e164394fcb7dd9f9ff3a02e20ca3a7b3f98e8a6,1547589873">
  ...
  <table>
    <tbody>
      <tr>
        <td><label> Last Name
            * </label></td>
        <td><input name="lastname" required="" type="text" maxlength="100" value="" data-label=""></td>
      </tr>
      <tr>
        <td><label> Primary Email
            * </label></td>
        <td><input name="email" required="" type="email" value="" data-label="Primary Email" td="" <=""></td>
      </tr>
      <tr>
        <td><label> Primary Phone
            * </label></td>
        <td><input name="phone" required="" type="text" maxlength="100" value="" data-label=""></td>
      </tr>
      <tr>
        <td><input name="cf_1001" type="hidden" maxlength="100" value="" data-label=""></td>
      </tr>
      <tr>
        <td><input name="designation" type="hidden" maxlength="100" value="" data-label=""></td>
      </tr>
      <tr>
