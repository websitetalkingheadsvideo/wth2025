...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../explanationvideo/fancybox/fancybox/jquery.fancybox-1.3.4.css" media="screen"/>
...
<body>
	...
	<section class="whiteboard-demo">
		<div class="row center-block">
			<div class="col-md-7 center-block">
				<div class="banner-text">Persuasive and Custom Drawing Videos, Drawing Explainer Video, Animated Drawing Videos</div>
				<div class="banner-video">
						<div class="poster-button" style="background:#3D9CEB"><i class="far fa-play-circle"></i></div>
					<a title="Whiteboard Video Example" href="https://www.websitetalkingheads.com/whiteboard/includes/whiteboard-video.html?lightbox[width]=1280&lightbox[height]=720" class="lightbox">
						<img src="https://www.websitetalkingheads.com/ivideo/videos/Whiteboard Animation.jpg" alt="Whiteboard Animation" class="img img-responsive">
					</a>
				</div>
			</div>
	...
	<section class="wrap">
		...
		<div class="content">
			...
			<div class="examples">
				<?php include ('../includes/examples-whiteboard-full.php'); ?>
				<div class="c"></div>
			</div>
